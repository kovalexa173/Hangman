...
def play(word):
    ...
    while not guessed and tries > 0:
        ...
        if len(guess) == 1 and guess.isalpha():
            if guess in guessed_letters:
                ...
                print(f'Отличная работа, буква {guess} присутствует в слове!')
                guessed_letters.append(guess)
            ...
            if guess in guessed_words:
                ...
                print(f'Слово {guess} не является верным.')
                tries -= 1
    ...
    if guessed:
        ...
        print(f'Вы не угадали слово. Загаданным словом было {word}. Может быть в следующий раз!')
